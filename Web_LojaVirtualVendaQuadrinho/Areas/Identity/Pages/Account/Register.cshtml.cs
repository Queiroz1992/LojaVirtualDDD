...
namespace Web_LojaVirtualVendaQuadrinho.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //CUSTOMIZAÇÃO DO IDENTITY USUARIO
                ...
                { 
                    ...
                    ComplementoEndereco = Input.ComplementeEndereco, 
                    Idade = Input.Idade, 
                    Nome = Input.Nome, 
                    Estado = true, 
                    Tipo = Entidades.Entidades.Enums.TipoUsuario.Comum,
                };
